...
def sign_new():
    sleep(2)
    poco(text='创建新账号').wait(20).click()
    sleep(2)
    poco(text='想要创作新角色').wait(20).click()
    if poco(text='删除已有角色的所有数据，开始创作新角色').wait(20).exists():
        poco(text='好的').click()
    sleep(3)
    poco(text='同意').wait(20).click()
    sleep(3)
    poco(text='下一步').wait(20).click()
    sleep(3)
    poco(text='以后再说').wait(20).click()
    sleep(10)
    check_pop()
    sleep(2)
...
#     poco(resourceId='cn.zepeto.main:id/fragmentMainBottomHomeIcon').click()
    ...
    sleep(3)
    check_pop()
    poco(text='注册崽崽').wait(20).click()
    sleep(3)
    poco(text='登录').wait(20).click()
    sleep(3)
    poco(name='cn.zepeto.main:id/inputPhoneEditText').wait(20).click()
    sleep(3)
    text('17600236632')
    poco(text='密码').click()
    text('piao12480')
    poco(resourceId='cn.zepeto.main:id/view_bar_button_text').wait(20).click()
    check_pop()
    sleep(5)
